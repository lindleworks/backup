<?php
	 ...
	 */
	$aColumns = array('JobId','Name','DbBackup','FileBackup','BackupDestinationType','Email','BackupFolder','BackupStorageFolder','ScheduleInterval','ScheduleDayOfMonth','ScheduleDayOfWeek','ScheduleHour','ScheduleMinute','FtpServer','FtpUsername','FtpPassword','FtpFolder','MaximumNumberOfBackups','DbPassword','DbUsername','DbServer','DbName','DateCreated','NextRunDate');
